...
public class Huffman {
    ...
    public static Map<Character, String> getCharPrefixHashMap() {
    ...
    public static String getFrequencyMap(String test){
        String ans = "";
    ...
    public static String getCharacterPrefixMap(String test){
        String ans = "";
